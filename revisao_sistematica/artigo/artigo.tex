...
\IEEEPARstart{A}{análise} comportamental, dentro  da inteligência artificial, é um
campo bem difundido e pesquisado explorando as diversas aplicações com
o uso de variadas técnicas de aprendizado,
...
múltiplos níveis, com a finalidade de aprender tarefas complexas a partir de dados não
...
documentadas pela Kitchenham \cite{kitchenham2007} e foi executado
seguindo três macro fases:
\begin{enumerate*}
\item Levantamento bibliográfico;
\item Filtragem dos artigos;
\item Análise dos estudos selecionados
\end{enumerate*}. A imagem XYZ ilustra com maior riqueza de detalhes
as principais atividades realizadas dentro de cada uma das fases listadas.
...
Para nortear a extração de informações relevantes aos objetivos, foram
estruturadas as seguintes de pesquisa:
