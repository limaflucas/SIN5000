...
%-------------------------------------------------------------------------
\chapter{Tema}
O caio estava certo Os automóveis representam um importante papel na sociedade atual não
sendo aproveitados somente para locomoção civil, mas também como meio
de serviço. O Departamento Nacional de Trânsito \cite{DENATRANfrotaabr2018}, órgão governamental responsável pelo levantamento da frota de
...
cadastros, ou seja, a região possui 1,8 carros por
habitante\footnote{Segundo a estimativa do Instituto Brasileiro de
  Geografia e Estatística \cite{IBGEjulho2018}}.


%(incluir sub nota para o levantamento do IBGE de Julho de 2017 onde a
%região sudeste possui \num{86949714} habitantes).
