...
sendo aproveitados somente para locomoção civil, mas também como meio
...
de 2018, que o Brasil possuía \num{98201128} veículos registrados \cite{DENATRANfrotaabr2018},
sendo que a região sudeste detém 48,63\% destes cadastros, o
equivalente a 1,8 carros por habitante\footnote{Utilizando a
  estimativa de \num{86949714} habitantes do Instituto Brasileiro de
  Geografia e Estatística \cite{IBGEjulho2018}}.

Ray Fuller propõe que o comportamento de um motorista pode ser
modelado considerando as capacidades do condutor e a
execução da tarefa de direção \cite{Fuller2005461}. A capacidade do condutor caracteriza a parcela biológica do
modelo, sendo responsável pela velocidade de processamento, tempo de
reação e seus limites físicos. Já a execução da tarefa de direção corresponde à parcela
sistemática que está sujeita a interferências externas,
como características ambientais e peculiaridades da via.
...
inferir a identidade do motorista, de forma não intrusiva, e
classificá-lo dentro de um grupo
